...
SOURCE_FILES = [
    FileInfo( 'list0.txt', int,   1000 ),
    FileInfo( 'list1.txt', int,   1000 ),
    FileInfo( 'list2.txt', int,   1000 ),
    FileInfo( 'list3.txt', int,   10 ),
    FileInfo( 'list4.txt', int,   1000 ),
    FileInfo( 'list5.txt', float, 1000 ),
]
